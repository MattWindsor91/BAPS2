...
namespace BAPSFormControls
{
    ...
    public partial class TrackTime : Control
    {
        ...
        private void SetPositionAndNotify(int newPosition)
        {
            ...
            PositionChanged.Invoke(this, new Requests.MarkerEventArgs((ushort)Channel, MarkerType.Position, (uint)position));
        }
        ...
        private void HandleCueDrag(int newPosition)
        {
            ...
            PositionChanged.Invoke(this, new Requests.MarkerEventArgs((ushort)Channel, MarkerType.Cue, (uint)cuePosition));
        ...
        private void HandleIntroDrag(int newPosition)
        {
            ...
            PositionChanged.Invoke(this, new Requests.MarkerEventArgs((ushort)Channel, MarkerType.Intro, (uint)introPosition));
        }
