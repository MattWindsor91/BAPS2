...
namespace BAPSClientCommon
{
    ...
    public static class ServerUpdates
    {
        ...
        /// <summary>
        ///     Payload for a channel marker (position/cue/intro/duration) server update.
        /// </summary>
        public class ChannelMarkerEventArgs : ChannelEventArgs
        {
            /// <summary>
            ...
            public ChannelMarkerEventArgs(ushort channelId, MarkerType marker, uint newValue) : base(channelId)
            {
                Marker = marker;
                NewValue = newValue;
            }
