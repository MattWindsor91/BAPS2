...
{
    /// <summary>
    ///     An <see cref="ILoginAttempter{TConn}"/> that always returns a
    ...
    public class DummyLoginAttempter<TConn> : ILoginAttempter<TConn> where TConn : class
    {
        private readonly ILoginResult _result;

        public DummyLoginAttempter(TConn? connection, ILoginResult? result)
        {
