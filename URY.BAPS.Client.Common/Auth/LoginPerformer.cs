...
{
    /// <summary>
    ///     Modular objects for co-ordinating the whole process of 'logging
    ///     into' a BAPS server.
    ///     <para>
    ...
    /// </typeparam>
    public class LoginPerformer<TRawConn, TAuthConn>
    {
        ...
        /// <summary>
        ///     Constructs a <see cref="LoginPerformer{TRawConn,TAuthConn}" />.
        /// </summary>
